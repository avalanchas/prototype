...
/**
 * Simple class factory with a builder method to generate a specific DataHandler. The factory is currently very
...
public class DataHandlerFactory {
     ...
     */
    public DataHandler getHandlerInstance(String type) {
        switch (type) {
            case "image":
